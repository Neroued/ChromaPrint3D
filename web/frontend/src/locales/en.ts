export default {
  ...
  recipeEditor: {
    title: 'Recipe Editor',
    close: 'Close',
    fullscreenOpen: 'Fullscreen Edit',
    fullscreenClose: 'Exit Fullscreen',
    fullscreenTitle: 'Fullscreen Recipe Editor',
    originalCompare: 'Original Image',
    originalCompareCollapse: 'Hide Original',
    originalCompareExpand: 'Show Original',
    resizeOriginalCompare: 'Resize original image window',
    resizeEditorColumns: 'Resize preview and recipe panels',
    resizeEditorRows: 'Resize color recipes and alternatives panels',
