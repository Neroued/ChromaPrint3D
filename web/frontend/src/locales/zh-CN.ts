...
export default {
  ...
  recipeEditor: {
    ...
    fullscreenTitle: '全屏配方编辑',
    originalCompare: '原图对比',
    originalCompareCollapse: '收起原图',
    originalCompareExpand: '显示原图',
    resizeOriginalCompare: '调整原图对比窗口大小',
    resizeEditorColumns: '调整预览区和配方栏宽度',
    resizeEditorRows: '调整颜色配方和替代配方区域高度',
